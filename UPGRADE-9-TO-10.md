...
1.2. Tambah Library baru: - `"spatie/laravel-ignition"` → `"^2.0"`,
(Laravel 10 sudah handle CORS via middleware bawaan).

1.3 Library yang dihapus: - `"fruitcake/laravel-cors"` → `"^2.0"`,
...
Laravel 10 tidak lagi menggunakan: - `protected $namespace = 'App\Http\Controllers';`
