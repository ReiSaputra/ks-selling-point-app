...
<head>
    ...
    <meta name="title" content="KS Selling Point App" />
        ...
        <nav class="app-header navbar navbar-expand bg-body">
            ...
            <div class="container-fluid">
                ...
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item d-none d-md-block"><a href="{{ route('order-list') }}" class="nav-link">Home</a>
                    </li>
                </ul>
